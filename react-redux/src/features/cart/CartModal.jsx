...
const CartModal = ({ handleHideModalCart }) => {
    ...
    return (
        <Modal>
            <div className="flex flex-col gap-g p-1: sm:p-2 w-full lg:w-[900px]">
                <div className="flex flex-col gap-6 max-h-[500px] overflow-auto">
                    {cartItems.map(product => {
                        return (
                            <div key={product.id} className="w-full border-b-4 border-blue-200 pb-4">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button 
                        type="button" 
                        className="bg-green-600 hover:bg-slate-800 text-white font-bold px-8 py-3 rounded-xl text-sm"
